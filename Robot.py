...
class Robot(object):
    ...
    def forward(self, power: float = 1):
        if power >= 0:
            ...
            raise ValueError("Power levels below zero are not allowed as inputs to Robot.forward.")
    ...
    def backward(self, power: float = 1):
        if power >= 0:
            ...
            raise ValueError("Power levels below zero are not allowed as inputs to Robot.backward.")