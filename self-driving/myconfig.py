...
JOYSTICK_STEERING_SCALE = 0.9  # some people want a steering that is less sensitive. This scalar is multiplied with the steering -1 to 1. It can be negative to reverse dir.
